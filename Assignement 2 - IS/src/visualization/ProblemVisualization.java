...
/**
 * This class allows visualizing the result of applying a policy on a problem which implements the interface ProblemView.
 */
public class ProblemVisualization {
    ...
    /**
     * Constructor. Takes a problem and the size of the window (in pixels) used to display the view.
     */
    ...
    /**
     * Visualizes the policy. Starts in the initial state and executes actions until reaching a terminal state.
     */
